...
<head>
  ...
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="galeri.php">GALERI</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasNavbarLabel">GALERI</h5>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
    <div class="container">
    <div class="mt-3">
    <h2 class= "text-center">SELAMAT DATANG DIHALAMAN GALERI!</h2>
    <div class="mt-5">
        </div>

     <img class="rounded float-start" width="300" height="300" src="../IMG/PKL.jpg"></img>
     <img class="rounded float-end" width="300" height="300" src="../IMG/Mirror.jpg"></img>
