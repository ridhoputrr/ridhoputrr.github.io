...
<body bgcolor=white style="margin:auto ;">
    <div class="container">
    <div class="mt-3">
    <h2 class= "text-center">LOGIN MURID</h2>
...
<table align="center" >
    ...
    <tr>
        ...
        <td><input type="username" class="form-control" name="usernamee" placeholder="username"></td>
    </tr>
    <tr>
        <td>Password</td>
    ...
    <div align="center">
      <a class="btn btn-primary" href="registerM.php" role="button">Register</a><br>
...
if(isset($_POST['proseslog'])){
    ...
    if($cek > 0){
        ...
        echo "<meta http-equiv=refresh content=0;URL='murid/index.php'>";
    }else{
        echo "<script>alert('Masukan Username Dan Password Yang Tepat');</script>";
        echo "<meta http-equiv=refresh content=2;URL='loginM.php'>";
    }
}
?>