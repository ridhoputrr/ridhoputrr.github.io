<?php
include "koneksi.php";
$sqlget=mysqli_query($koneksi,"select * from siswa,nilai where nisn='$_GET[kode]'");
...
<head>
  ...
  <div class="card-header bg-secondary text-white">
    ...
    <div class="d-grid gap-2">  
        <a href="nilaisiswa.php" class="btn btn-secondary mt-3">Kembali</a>
        <form action="editnilai.php" method="post">
            ...
            <input class="form-control" type="text" name="mapel" value="<?php echo $data['mapel'];?>">
        
         
            <div class="mt-3">
            <label for="nilai1" class="col-form-label"><h6>Nilai 1</h6></label>
            <input class="form-control" type="text" name="nilai1" value="<?php echo $data['nilai1'];?>">
        
        
            <div class="mt-3">
            <label for="nilai2" class="col-form-label"><h6>Nilai 2</h6></label>
            <input class="form-control" type="text" name="nilai2" value="<?php echo $data['nilai2'];?>">
        
        
            <div class="mt-3">
            <label for="nilai3" class="col-form-label"><h6>Nilai 3</h6></label>
            <input class="form-control" type="text" name="nilai3" value="<?php echo $data['nilai3'];?>">
